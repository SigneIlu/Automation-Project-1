describe('Issue comments creating, editing and deleting', () => {
    ...
    it('Should create, edit and delete comment successfully - Signe', () => {
        
        //constant selectors
        const issueComment = '[data-testid="issue-comment"]'
        //constant values
        const comment = 'TEST_COMMENT_Signe';
        const comment_edited = 'TEST_COMMENT_EDITED_Signe';
        ...
        getIssueDetailsModal().within(() => {
            ...
            cy.get('[data-testid="modal:confirm"]').contains('button', 'Delete comment').click()
                .should('not.exist');
            getIssueDetailsModal().contains(comment_edited)
                .should('not.exist');
            });
